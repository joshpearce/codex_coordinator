...
directory holds `operator.toml` for service settings, the overall
...
tasks, and what reaches a judge is decided by each child project's
`.codex/config.toml`. The coordinator profile can inspect sibling outputs but
