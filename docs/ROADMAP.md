...
| M1.5 — Coordinator operability | Blocking waits (#0013), concise orchestration events (#0014), restart continuity (#0015), durable workspace launch (#0016), actionable preflight errors (#0017), usable cursor recovery (#0018), and small-context monitoring guidance (#0027) | Offline lifecycle/load and template tests plus a live parent/child coordination run with no sleep polling, raw-event filtering, lost continuity, or routine waits resuming the main parent context |
