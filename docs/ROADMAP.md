...
Within M4, the file-change split is complete: inside its project a worker acts
by right under the sandbox, and a judge decides what leaves it. Its remaining
M4 siblings — restricted judge reads (#0006), narrowed coordinator egress
(#0007), allowed-root hardening (#0005), and the refusal of worker-written
project rules (#0017) — are open.
