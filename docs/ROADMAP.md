...
| M1.5 — Coordinator operability | Blocking waits (#0013), concise orchestration events (#0014), restart continuity (#0015), durable workspace launch (#0016), actionable preflight errors (#0017), and usable cursor recovery (#0018) | Offline lifecycle/load tests plus a live parent/child coordination run with no sleep polling, raw-event filtering, or lost continuity |
